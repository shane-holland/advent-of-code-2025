...
public partial class AdventOfCodeClient
{
    ...
    public AdventOfCodeClient(HttpClient httpClient, ILogger<AdventOfCodeClient>? logger = null)
    {
    ...
    public async Task<string> GetPuzzleInputAsync(int year, int day, string sessionCookie)
    {
        ...
        request.Headers.Add("User-Agent", "advent-of-code-2025-cli/1.0.0 (.NET 9)");
